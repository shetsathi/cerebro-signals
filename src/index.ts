...
export { TradeExecution, TradeDirection, ExitType, ExecutionStatus } from './domain/trade-execution';
export { TradeExecutionRepository } from './persistence/trade-execution-repository.interface';
...
export { PerformanceMetrics, PeriodType, PerformanceSummary } from './domain/performance-metrics';
